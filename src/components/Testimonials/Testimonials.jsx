      ...
      <section>
        <div className="max-w-[1400px] mx-auto px-10 py-20">
          ...
          >
            {review.map((item) => {
              return (
                <SwiperSlide key={item.id} className="bg-zinc-100 p-8 rounded-xl min-h-[350px] flex flex-col justify-between">
                  <div className="flex items-center gap-5">
                    <div className="w-16 h-16 rounded-full bg-red-500 outline-2 outline-orange-500 outline-offset-4 overflow-hidden">
                      <img src={item.image} className="h-full w-full" />
                    </div>
                  ...
                  <div className="mt-10">
                    <p className="text-zinc-600 line-clamp-5">{item.feedback}</p>
                  </div>
                </SwiperSlide>
              );
            })}
